...
func runtimeConfigPath(workDir, provider string) string {
	...
	//
	// Fork overlay: OMP is both a builtin ID and an ACP protocol family.
	// Recursing on ProtocolFamily == ID would overflow the stack.
	...
	case "codex", "copilot", "opencode", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "reasonix", "dsh", "kiro", "antigravity", "qoder", "qoderclicn", "traecli", "grok", "qwenpaw", "mcode", "dim", "omp", "devin":
