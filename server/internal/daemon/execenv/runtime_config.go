...
// For OMP:         writes {workDir}/AGENTS.md  (omp reads AGENTS.md natively)
...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "kiro", "antigravity", "qoder", "traecli", "omp", "grok":
