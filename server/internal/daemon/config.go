...
type Config struct {
	...
	Agents                         map[string]AgentEntry // keyed by provider: claude, codebuddy, codex, copilot, opencode, openclaw, hermes, pi, cursor, kimi, kiro, antigravity, qoder, traecli, omp, grok, qwen
...
var defaultAgentCommandNames = []string{
	...
	"pi", "cursor-agent", "copilot", "kimi", "kiro-cli", "codebuddy", "agy", "qodercli", "traecli", "omp", "grok", "qwen",
}
