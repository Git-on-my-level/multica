...
func (h *Handler) DeleteWorkspace(w http.ResponseWriter, r *http.Request) {
	...
	if err := qtx.DeleteWorkspacePRHandoffCandidates(r.Context(), requester.WorkspaceID); err != nil {
		slog.Warn("delete workspace PR handoffs failed", append(logger.RequestAttrs(r), "error", err, "workspace_id", workspaceID)...)
		writeError(w, http.StatusInternalServerError, "failed to delete workspace")
		return
	}
