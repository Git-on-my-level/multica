...
// migration 441 to add codearts, and fork overlay migration 9018 to add
...
var SupportedTypes = []string{
	...
	"dim",
	"zeroclaw",
	// Fork overlay: omp and devin are first-class protocol families here
	// (ACP backends ompBackend / devinBackend), not pi-family identities.
	"omp",
	"devin",
	// Fork overlay: ZCode (Z.ai) driven over ACP through the
	// zcode-acp-server bridge (port of upstream #6987).
	"zcode",
}
