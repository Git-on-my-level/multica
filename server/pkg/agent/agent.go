...
// OpenClaw, Hermes, Pi, Cursor, Kimi, Kiro, Antigravity, Qoder, Trae, OMP,
// Grok, Qwen Code). It
...
// runtime_profile.protocol_family CHECK constraint (migration 120, widened by
	// migration 134 to add qoder, migration 136 to add traecli, migration 143 to
	// add omp, migration 175 to add deveco, migration 179 to add grok, and
	// migration 202 to add qwen): a
