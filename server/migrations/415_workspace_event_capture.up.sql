...
-- sequence.
CREATE FUNCTION append_workspace_event(
    p_workspace_id UUID,
    p_source_id TEXT,
    p_event_type TEXT,
...
CREATE FUNCTION capture_issue_workspace_event() RETURNS trigger
LANGUAGE plpgsql
AS $$
DECLARE
    row_data issue;
...
CREATE FUNCTION capture_comment_workspace_event() RETURNS trigger
LANGUAGE plpgsql
AS $$
DECLARE
    row_data comment;
...
CREATE FUNCTION capture_task_workspace_event() RETURNS trigger
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE FUNCTION capture_run_workspace_event() RETURNS trigger
LANGUAGE plpgsql
AS $$
DECLARE
...
CREATE FUNCTION capture_artifact_workspace_event() RETURNS trigger
LANGUAGE plpgsql
AS $$
DECLARE
    row_data attachment;
